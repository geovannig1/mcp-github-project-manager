...
async function runPublish() {
  try {
    ...
    try {
      const releaseNotes = `## v${newVersion}\n\nSee [CHANGELOG.md](https://github.com/geovannig1/mcp-github-project-manager/blob/main/CHANGELOG.md) for details.\n\n📦 **npm:** \`npm install mcp-github-project-manager@${newVersion}\``;
      ...
      console.log(`   https://github.com/geovannig1/mcp-github-project-manager/releases/new?tag=v${newVersion}`);
    }

    console.log(`\n✅ Successfully published version ${newVersion}!`);
    console.log(`   npm: https://www.npmjs.com/package/mcp-github-project-manager`);
    console.log(`   GitHub: https://github.com/geovannig1/mcp-github-project-manager/releases/tag/v${newVersion}`);
  } catch (error) {
